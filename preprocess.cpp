...
///////////////////////////////////////////////////////////////////////////////////////////////////
void Preprocess::preprocess(cv::Mat &imgOriginal, cv::Mat &imgGrayscale, cv::Mat &imgThresh) {
...
///////////////////////////////////////////////////////////////////////////////////////////////////
cv::Mat Preprocess::extractValue(cv::Mat &imgOriginal) {
    cv::Mat imgHSV;
...
///////////////////////////////////////////////////////////////////////////////////////////////////
cv::Mat Preprocess::maximizeContrast(cv::Mat &imgGrayscale) {
    cv::Mat imgTopHat;
    cv::Mat imgBlackHat;

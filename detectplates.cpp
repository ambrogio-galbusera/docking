...
///////////////////////////////////////////////////////////////////////////////////////////////////
std::vector<PossiblePlate> DetectPlates::detectPlatesInScene(cv::Mat &imgOriginalScene)
{
    ...
    std::vector<std::vector<PossibleChar> > vectorOfVectorsOfMatchingCharsInScene = DetectChars::findVectorOfVectorsOfMatchingChars(vectorOfPossibleCharsInScene);
...
PossiblePlate extractPlate(cv::Mat &imgOriginal, std::vector<PossibleChar> &vectorOfMatchingChars) {
    ...
    double dblHypotenuse = DetectChars::distanceBetweenChars(vectorOfMatchingChars[0], vectorOfMatchingChars[vectorOfMatchingChars.size() - 1]);
...
///////////////////////////////////////////////////////////////////////////////////////////////////
std::vector<PossibleChar> DetectPlates::findPossibleCharsInScene(cv::Mat &imgThresh) {
    std::vector<PossibleChar> vectorOfPossibleChars;            // this will be the return value
...
///////////////////////////////////////////////////////////////////////////////////////////////////
PossiblePlate DetectPlates::extractPlate(cv::Mat &imgOriginal, std::vector<PossibleChar> &vectorOfMatchingChars) {
    PossiblePlate possiblePlate;            // this will be the return value
